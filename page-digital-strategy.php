				...
				<div class="ms-Grid-col ms-u-sm12 ms-u-xl6">
					<div class='ms-Grid-row'>
						...
						<div class="ms-Grid-col ms-u-sm11">
							<p class="ms-font-xl">End the cycle of resolving short-term needs. Develop an IT roadmap and act more inline with the strategy of your organization.</p>
						</div>
					</div>
					<div class='ms-Grid-row'>
						<div class="ms-Grid-col ms-u-sm1 ms-u-textAlignRight">
						...
						<div class="ms-Grid-col ms-u-sm11">
							<p class="ms-font-xl">With growth in global competition, hiring the right candidate has become more competitive. Find the talent you need, when you need it.</p>
						</div>
					</div>
					<div class='ms-Grid-row'>
						<div class="ms-Grid-col ms-u-sm1 ms-u-textAlignRight">
						...
						<div class="ms-Grid-col ms-u-sm11">
							<p class="ms-font-xl">Save money, time, and energy with Cloud Computing. Experience the future of IT Hosting.</p>
						</div>
					</div>
					<div class='ms-Grid-row'>
						<div class="ms-Grid-col ms-u-sm1 ms-u-textAlignRight">
						...
						<div class="ms-Grid-col ms-u-sm11">
							<p class="ms-font-xl">Traditional marketing is no longer enough. Engage with customers and brand your business through digital mediums.</p>
						</div>
					</div>
				</div>
            </div>
