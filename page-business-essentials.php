            ...
            <div class='ms-Grid-row'>
              <header class="ms-Grid-col ms-u-sm11 ms-u-lg8 ms-u-lgPush2 color-white" style="background: rgba(33, 33, 33, .95);">
				<div class="ms-u-textAlignCenter">
					<h1 class="ms-font-su">Business Essentials</h1>
					<span class="subtitle ms-font-xxl">Keep up with heavy workloads while protecting client information</span>
				</div>
              </header>
            </div>
          </div>
            ...
            <div class='ms-Grid-row'>
              ...
              <div class="ms-Grid-col ms-u-sm12 ms-u-md6 ms-u-lg4">
                <div class="card ms-u-textAlignCenter" style="max-width:350px;">
                  ...
                  <div class='card-contents'>
                    <h2 class="ms-font-su card-title">Optimize your firm</h2>
                    <div class='excerpt ms-font-xl'>Wherever your people are, online or offline, they can get to-and work with the files and tools they need to get things done. And they can do it on virtually any device.</div>
                  </div>
                </div>
              </div>
              <div class="ms-Grid-col ms-u-sm12 ms-u-md6 ms-u-lg4">
          ...
          <div class='ms-Grid'>
			<div class="ms-Grid-row">
				<div class="ms-Grid-col ms-u-sm12 ms-u-textAlignCenter">
					<h2 class="ms-font-xxl">Customizable packages</h2>
				</div>
			</div>
            <div class='ms-Grid-row'>
				...
				<div class="ms-Grid-col ms-u-sm12 ms-u-xl6">
					<div class='ms-Grid-row'>
						...
						<div class="ms-Grid-col ms-u-sm11">
							<p class="ms-font-xl">Don't waste money on things you don't need. We'll analyze your business and build the perfect solution.</p>
						</div>
					</div>
					<div class='ms-Grid-row'>
						<div class="ms-Grid-col ms-u-sm1 ms-u-textAlignRight">
